...
// USE_COMPILED_WEIGHTS is defined in gru_weights.h for every reported build: weights are compiled-in constants.
// The #else branch below is an alternate runtime-load (m_axi) configuration; not used for any reported deployment.
...
#else // alternate runtime m_axi load configuration; not used for reported deployments
